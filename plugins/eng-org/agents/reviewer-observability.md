...
ARCHITECTURE.md (§5 SLOs and observability). The dev-report.
...
- REQ-20260713-d904-03 TASK-10 (Change 8a, enacted in fix-iteration-1): pruned the §Required reading list above to observability-axis surfaces.
  - removed: `MISTAKES.md filter [logging, observability, metrics, alert, pii]` — per-REQ curated MISTAKES slice arrives via the context pack.
